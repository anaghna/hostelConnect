  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.value}>{userData.user.emailid}</Text>
        <Text style={styles.label}>Mobile:</Text>
        <Text style={styles.value}>{userData.user.phoneno}</Text>
        <Text style={styles.label}>Distance from College:</Text>
        <Text style={styles.value}>{userData.user.Distance} km</Text>
      </View>
      
      <View style={styles.card}>
        <Text style={styles.label}>Upload Your Mess Image URL:</Text>
      <TextInput
        style={styles.input}
